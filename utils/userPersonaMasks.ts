...
const DEFAULT_SURFACE_POLICY: Partial<Record<UserProgressSurface, UserProgressSurfacePolicy>> = {
    chat: 'mask_scoped',
    proactive_letter: 'mask_scoped',
    group_chat: 'mask_scoped',
    call: 'mask_scoped',
    date: 'mask_scoped',
    social: 'mask_scoped',
    novel: 'mask_scoped',
    storydesk: 'mask_scoped',
    guidebook: 'mask_scoped',
    special_moments: 'mask_scoped',
    contact_impression: 'mask_scoped',
    exchange_diary: 'mask_scoped',
    check_phone: 'mask_scoped',
    songwriting: 'mask_scoped',
    companion_plan: 'mask_scoped',

...
const FAQ_DATA = [
    ...
    {
        q: "2. 发了消息，角色不回我 / 闪电是什么？",
        reason: "可能是当前回复方式被切到了“手动接话”，也可能是 API 还没配置好。",
        solution: "自动回复：默认情况下，你发完消息后角色会自动思考并回复。\n手动接话：如果切到了手动模式，发完消息后需要点顶部右侧的闪电，让角色接一句。\n回复方式：点闪电旁边的小状态点，可以切换“手动接话 / 自动回复 / 主动来信”。\n如果三种方式都没有反应，请再检查「设置」里的 API URL / Key / Model。",

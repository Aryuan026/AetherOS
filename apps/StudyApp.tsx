...
const StudyApp: React.FC = () => {
                ...
                <div className="p-6 flex-1 overflow-y-auto no-scrollbar">
                    {allQuizzes.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full text-slate-400">
                            ...
                            <span className="text-xs mt-1">在书房的课堂中点击「刷题」开始吧</span>
                        </div>
                    ) : (
    ...
    if (mode === 'quiz') {
        return (
            <div className="h-full w-full bg-[#fdfbf7] flex flex-col font-sans relative">
                <AppHeader
                    title={quizSession?.chapterTitle || '做题中'}
                    onBack={() => {
    ...
    if (mode === 'bookshelf') {
        return (
            <div className="h-full w-full bg-[#fdfbf7] flex flex-col font-sans relative">
                ...
                <Modal isOpen={showStudySettings} title="书房设置" onClose={() => setShowStudySettings(false)}>
                    <div className="space-y-6">
